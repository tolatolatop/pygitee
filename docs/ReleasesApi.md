...
> InlineResponse20045 repos_owner_repo_releases_get(owner, repo, access_token=access_token, page=page, per_page=per_page, direction=direction)
...
> InlineResponse20045 repos_owner_repo_releases_id_get(owner, repo, id, access_token=access_token)
...
> InlineResponse20045 repos_owner_repo_releases_latest_get(owner, repo, access_token=access_token)
...
> InlineResponse20045 repos_owner_repo_releases_tags_tag_get(owner, repo, tag, access_token=access_token)
